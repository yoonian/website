...
[잡](/ko/docs/concepts/jobs/run-to-completion-finite-workloads/)의 `.spec.selector` 와 같은 동작을 한다.
...
[스태틱 파드](/docs/concepts/cluster-administration/static-pod/)라고 부른다.
